...
export default class success extends Component {
  ...
  orderConfirm = () => {
    ...
    axiosInstance
      ...
      .then((response) =>
        this.setState({
          order_data: response.data.order_qs,
          loading: false,
        })
      )
      .catch((error) =>
  ...
  render() {
    return (
      <>
        ...
        <div className="wrapper-success p-5">
          {this.state.loading ? (
            <LoadingOverlay
            ...
            <div className="screen">
              <svg className="clouds" viewBox="0 0 243 172">
                <defs>
                  <linearGradient id="a" x1="0%" y1="21.631%" y2="78.369%">
                    <stop offset="0%" stopColor="#FCCF31" />
              ...
              <svg className="plane" viewBox="0 0 139 139">
                <defs>
                  <linearGradient
                    id="a"
                    x1="147.152%"
              ...
              {/* <p className="message">Order Id : 64ASDASC654</p> */}
              <Link
                href={`/user/track-order/query?=${this.state.order_data.order_id}`}
              >
                <h2 className="btn button">Track Order</h2>
              </Link>
            </div>
          )}
        </div>
