    ...
    return (
      <div>
        ...
        <section id="terms-of-service container mt-5">
          <div className="card">
            <h1 className="primary-heading mt-5">Privacy Policy</h1>
            <div className="paragraph">
              <h6>Welcome to proman.clothing!</h6>
              <br />
              <p>
                At proman.clothing, accessible from https://proman.clothing/,
                one of our main priorities is the privacy of our visitors. This
                Privacy Policy document contains types of information that is
                collected and recorded by proman.clothing and how we use it.
              </p>
              <br />
              <p>
            ...
            <div className="paragraph">
              ...
              <ul className="p-4">
                ...
                <li>5.Send you emails</li>
                <li>6.Find and prevent fraud</li>
              </ul>
            </div>
            <div className="paragraph">
              <h2>Log Files</h2>
              <br />
              <p>
                proman.clothing follows a standard procedure of using log files.
            ...
            <div className="paragraph">
              ...
              <hr />
              <p>
                Like any other website, proman.clothing uses 'cookies'. These
            ...
            <div className="paragraph">
              ...
              <p>
                ...
                the advertising partners of proman.clothing.
              </p>
              <br />
              <p>
                ...
                proman.clothing, which are sent directly to users' browser. They
              ...
              <br />
              <p>
                Note that proman.clothing has no access to or control over these
            ...
            <div className="paragraph">
              ...
              <br />
              <p>
                proman.clothing's Privacy Policy does not apply to other
            ...
            <div className="paragraph">
              ...
              <br />
              <p>
                proman.clothing does not knowingly collect any Personal
            ...
            <div className="paragraph">
              ...
              <br />
              <p>
                The Company respects your privacy and if you do not want to
                receive any kind of communications from bewakoof.com or have any
                grievances to share, please report to:
              </p>
              <br />
              <div className="p-3">
                <p>Name: Shahriar Sohan</p>
                <p>Email: sohan@proman.clothing</p>
              </div>
            </div>
          </div>
        </section>
